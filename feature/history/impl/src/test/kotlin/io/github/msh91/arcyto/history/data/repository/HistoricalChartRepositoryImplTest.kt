...
class HistoricalChartRepositoryImplTest {
    ...
    @Test
    fun `getHistoricalChart should return historical chart`() =
        runTest {
            // WHEN
            val request =
    ...
    @Test
    fun `getLatestCoinPrice should return latest coin price`() =
        runTest {
            // GIVEN
            val apiModel =
                mapOf(
    ...
    private fun getHistoricalChart() =
        HistoricalChart(
            chartPrices =
                listOf(
    ...
    private fun getApiModel() =
        HistoricalChartApiModel(
            prices =
                listOf(
                    listOf(100.0, 1000.0),
                    listOf(200.0, 2000.0),
